...
def chatbot_page():
    ...
    with st.container():
        ...
        user_input = st.text_area("You:", "", key="input_text", placeholder="Type your message...", height=100)
        if st.button("Send", key="send_button"):
            ...
            if best_match:
                ...
                st.session_state.chat_history.append("Bot: I don't know the answer. Can you teach me?")
                new_answer = st.text_input("Type the answer or 'skip' to skip: ", key="new_answer")
                if new_answer and new_answer.lower() != 'skip':
                    knowledge_base["questions"].append({"question": user_input, "answer": new_answer})
                    save_knowledge_base('knowledge_base.json', knowledge_base)
                    st.session_state.chat_history.append("Bot: Thank you! I learned a new response!")
            
            st.session_state.loading = False
            st.experimental_rerun()  # Refresh the chat history view
